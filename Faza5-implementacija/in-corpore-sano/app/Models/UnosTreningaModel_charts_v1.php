...
class UnosTreningaModel_charts_v1 {
     ...
     * Returns number of calories (result) burned by the user for each day of the current week (day_of_week).
     ...
     * Returns number of calories (result) burned by the user for each day of the current month (day_in_month).
     * Only days for which record exists are counted.
     * @param $user_id
     * @return array|array[]
     */
     ...
     * Returns average number of calories (result) burned by the user for each month (month) of the current year.
     * Only days for which record exists are counted.
     * @param $user_id
     * @return array|array[]
     */
