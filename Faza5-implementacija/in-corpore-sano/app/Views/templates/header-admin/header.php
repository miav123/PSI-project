        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav" style="float:right;">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item <?= ($uri->getSegment(2) == 'challenges' ? 'active' : null) ?>">
                        <a class="nav-link" href="/admin/challenges">CHALLENGES</a>
                    </li>
                    <li class="nav-item <?= ($uri->getSegment(2) == 'trainers' ? 'active' : null) ?>">
                        <a class="nav-link" href="/admin/trainers">TRAINERS</a>
                    </li>
                    <li class="nav-item <?= ($uri->getSegment(2) == 'users' ? 'active' : null) ?>">
